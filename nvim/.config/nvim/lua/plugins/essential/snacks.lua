return {
	...
	keys = {
		...
		{ "<leader>gp", function() Snacks.picker.gh_pr() end, desc = "[G]it Open [P]R" },
		{ "<leader>gP", function() Snacks.picker.gh_pr({ state = "all" }) end, desc = "[G]it All [P]R" },
		{ "<leader>gi", function() Snacks.picker.gh_issue() end, desc = "[G]it Open [I]ssues" },
		{ "<leader>gI", function() Snacks.picker.gh_issue({ state = "all" }) end, desc = "[G]it All [I]ssues" },

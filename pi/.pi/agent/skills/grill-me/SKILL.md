...
- A workflow needs a bounded optional critique checkpoint before a risky design choice, broad implementation plan, unclear requirement, PR-boundary tradeoff, or safety-sensitive change where hidden assumptions could alter the path.
...
- Keep workflow-invoked checkpoints lightweight unless the user explicitly asks to be grilled or the risk justifies deeper stress testing.

...
Use a task-specific workspace under `/tmp/pi`, for example:

```bash
WORKSPACE=/tmp/pi/phoenix-inspector-prompt-integration-2026-05-10
mkdir -p "$WORKSPACE"
```
